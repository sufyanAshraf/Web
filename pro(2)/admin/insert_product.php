...
{
    $por_title = $_POST['pro_title'];
    $por_cat = $_POST['pro_cat'];
    $por_brand = $_POST['pro_brand'];
    $por_price = $_POST['pro_price'];
    $por_desc = $_POST['pro_desc'];
    $por_kw = $_POST['pro_kw'];
    $por_img = $_POST['pro_img'];


    $insertQuery =  "INSERT INTO `products`( `pro_Title`, `pro_cat`, `pro_brand`, `pro_price`, `pro_desc`,`pro_keywords`, `pro_image`)
    VALUES ('$por_title','$por_cat','$por_brand','$por_price','$por_desc','$por_kw', 'img/$por_img');";
