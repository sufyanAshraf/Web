...
if(isset($_POST['insert_pro'])){
    ...
    $cat = $_POST['cat'];
    $insert_product = "INSERT INTO `brands`( `brand_title`) VALUES ('$cat');";
...
<body>
<div class="container">
    <h1 class="text-center my-4"><i class="fas fa-plus fa-md"></i> <span class="d-none d-sm-inline"> Add New </span> Product brand</h1>
        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                <div class="input-group">
                    <input type="text" class="form-control" id="pro_title" name="cat" placeholder="Enter brand" >
                </div>
            </div>
        </div>
        <div class="row my-3">
